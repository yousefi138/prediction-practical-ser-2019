...
```
```{r call_source, echo}
read_chunk("/home/py16069/repos/prediction-practical-2019/prediction-practical-2019-sourcecode.r")
```
...
```{r load.joehanes_students, eval = F, echo=T} 
```
```{r load.joehanes_me} 
```
...
```{r answers2_2, eval=F, echo=T}  
```
```{r answers2_2, eval=T, echo=F}  
```

## ANSWER TIME!

```{r answers2_2_roc, echo=T} 
```
